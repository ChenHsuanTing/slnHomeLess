...
namespace prjHomeLess.Controllers
{
    public class MemberController : Controller
    {
        ...
        //public IActionResult Detail(CMemberView vModel, int? id)
        ////{
        ...
        //}
        public IActionResult List(CMemberView vModel)
        {
            //我救浪Context db = new 我救浪Context();
        ...
        public IActionResult showDetail(string str)
        {
            我救浪Context db = new 我救浪Context();
            var a = db.Members.Where(x => x.MemberId == int.Parse(str)).FirstOrDefault();
